...
function NavBar({ logout }) {
    ...
    return (
        ...
        <div className="flex justify-between items-center mx-auto px-4">
          <Link to="/" className="text-xl font-bold text-white hover:text-gray-600">PT Spanish</Link>
          <div className="flex space-x-4">
            <NavLink exact to="/" activeClassName="text-gray-600" className="text-white hover:text-gray-600">Home</NavLink>
